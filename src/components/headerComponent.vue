<template>
  <div class="headerComponent">
    <div class="h-controller">
      ...
      <div class="h-tab">
        <ul>
          <router-link to="/findMusicComponent">
            <li
              v-bind:class="{ active: layout.changeColor[0] }"
              @click="changeBgcEvent(0)"
            ><span><a href="">{{$t('m.findMusic')}}</a></span></li>
          </router-link>
          <router-link to="/myMusicComponent">
            <li
              v-bind:class="{ active: layout.changeColor[1] }"
              @click="changeBgcEvent(1)"
            ><span><a href="">{{$t('m.myMusic')}}</a></span></li>
          </router-link>
          <router-link to="/friendComponent">
            <li
              v-bind:class="{ active: layout.changeColor[2] }"
              @click="changeBgcEvent(2)"
            ><span><a href="">{{$t('m.friend')}}</a></span></li>
          </router-link>
          <router-link to="/musicManComponent">
            <li
              v-bind:class="{ active: layout.changeColor[3] }"
              @click="changeBgcEvent(3)"
            ><span><a href="">{{$t('m.musician')}}</a></span></li>
          </router-link>
          <router-link to="/downLoadComponent">
            <li
              v-bind:class="{ active: layout.changeColor[4] }"
              @click="changeBgcEvent(4)"
            ><span><a href="">{{$t('m.download')}}</a></span></li>
          </router-link>
        </ul>
      </div>
      <div class="h-search">
